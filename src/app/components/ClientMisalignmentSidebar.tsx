      ...
      <div className="relative w-[520px] h-full bg-white shadow-2xl flex flex-col animate-slide-in-right overflow-hidden">
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {enabledClients.map(client => (
                    <div key={client.name} className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-green-50 border border-green-100">
        ...
        <div className="border-t border-[#e5f2f4] px-6 py-4 bg-white shrink-0">
          ...
          {isAligned && (
            <button
              onClick={onClose}
              className="w-full mt-2 py-2 rounded bg-[#2A96A8] text-white text-sm hover:bg-[#237f8e] transition-colors font-medium"
            >
              Confirm Alignment
            </button>
          )}
