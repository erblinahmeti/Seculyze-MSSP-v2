        ...
        <div className="flex-1 overflow-y-auto">
          <div className="px-6 py-5 space-y-5">
            ...
            {(() => {
              ...
              return (
                <div className={`rounded-[8px] p-4 border ${target === 'enabled' ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-[var(--stroke)]'}`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-gray-50 border border-[var(--stroke)] rounded-[8px] p-4">
                <div className="flex items-center gap-2 mb-2">
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {enabledClients.map(client => (
                    <div key={client.name} className="flex items-center justify-between px-3 py-2.5 rounded-[8px] bg-[#f6f6f6] border border-[#e5f2f4]">
                      <div className="flex items-center gap-3">
                        ...
                        <span className={`px-2 py-0.5 rounded-[8px] text-[10px] font-medium ${LEVEL_COLORS[client.level]}`}>
                          {client.level}
                        </span>
                      </div>
                      <button
            ...
            {isAligned && clients.length > 0 && (
              <div className={`rounded-[8px] border p-4 flex items-center gap-3 ${
                enabledClients.length > 0
        ...
        <div className="border-t border-[#e5f2f4] px-6 py-4 bg-white shrink-0">
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 py-2 rounded-[8px] border border-[var(--stroke)] text-sm text-[#092E3F] hover:bg-gray-50 transition-colors font-medium"
            >
              Disable All
            </button>
            <button
              onClick={() => alignAll(true)}
              className="flex-1 py-2 rounded-[8px] bg-[#092e3f] text-white text-sm hover:bg-[#092e3f]/90 transition-colors font-medium"
            >
              Enable All
            </button>
          </div>
          {isAligned && (
            <button
              onClick={onClose}
              className="w-full mt-2 py-2 rounded-[8px] bg-[#092e3f] text-white text-sm hover:bg-[#092e3f]/90 transition-colors font-medium"
            >
              Confirm Alignment
            </button>
          )}
